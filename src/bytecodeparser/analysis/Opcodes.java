...
public class Opcodes {
	...
	static {
		...
		opcodes.put(Opcode.ILOAD, new LocalVariableOpcode(Opcode.ILOAD, true));
		opcodes.put(Opcode.LLOAD, new LocalVariableOpcode(Opcode.LLOAD, true));
		opcodes.put(Opcode.FLOAD, new LocalVariableOpcode(Opcode.FLOAD, true));
		opcodes.put(Opcode.DLOAD, new LocalVariableOpcode(Opcode.DLOAD, true));
		opcodes.put(Opcode.ALOAD, new LocalVariableOpcode(Opcode.ALOAD, true));
		opcodes.put(Opcode.ILOAD_0, new LocalVariableOpcode(Opcode.ILOAD_0, true));
		opcodes.put(Opcode.ILOAD_1, new LocalVariableOpcode(Opcode.ILOAD_1, Opcode.ILOAD_0, true));
		opcodes.put(Opcode.ILOAD_2, new LocalVariableOpcode(Opcode.ILOAD_2, Opcode.ILOAD_0, true));
		opcodes.put(Opcode.ILOAD_3, new LocalVariableOpcode(Opcode.ILOAD_3, Opcode.ILOAD_0, true));
		opcodes.put(Opcode.LLOAD_0, new LocalVariableOpcode(Opcode.LLOAD_0, true));
		opcodes.put(Opcode.LLOAD_1, new LocalVariableOpcode(Opcode.LLOAD_1, Opcode.LLOAD_0, true));
		opcodes.put(Opcode.LLOAD_2, new LocalVariableOpcode(Opcode.LLOAD_2, Opcode.LLOAD_0, true));
		opcodes.put(Opcode.LLOAD_3, new LocalVariableOpcode(Opcode.LLOAD_3, Opcode.LLOAD_0, true));
		opcodes.put(Opcode.FLOAD_0, new LocalVariableOpcode(Opcode.FLOAD_0, true));
		opcodes.put(Opcode.FLOAD_1, new LocalVariableOpcode(Opcode.FLOAD_1, Opcode.FLOAD_0, true));
		opcodes.put(Opcode.FLOAD_2, new LocalVariableOpcode(Opcode.FLOAD_2, Opcode.FLOAD_0, true));
		opcodes.put(Opcode.FLOAD_3, new LocalVariableOpcode(Opcode.FLOAD_3, Opcode.FLOAD_0, true));
		opcodes.put(Opcode.DLOAD_0, new LocalVariableOpcode(Opcode.DLOAD_0, true));
		opcodes.put(Opcode.DLOAD_1, new LocalVariableOpcode(Opcode.DLOAD_1, Opcode.DLOAD_0, true));
		opcodes.put(Opcode.DLOAD_2, new LocalVariableOpcode(Opcode.DLOAD_2, Opcode.DLOAD_0, true));
		opcodes.put(Opcode.DLOAD_3, new LocalVariableOpcode(Opcode.DLOAD_3, Opcode.DLOAD_0, true));
		opcodes.put(Opcode.ALOAD_0, new LocalVariableOpcode(Opcode.ALOAD_0, true));
		opcodes.put(Opcode.ALOAD_1, new LocalVariableOpcode(Opcode.ALOAD_1, Opcode.ALOAD_0, true));
		opcodes.put(Opcode.ALOAD_2, new LocalVariableOpcode(Opcode.ALOAD_2, Opcode.ALOAD_0, true));
		opcodes.put(Opcode.ALOAD_3, new LocalVariableOpcode(Opcode.ALOAD_3, Opcode.ALOAD_0, true));
		...
		opcodes.put(Opcode.ISTORE, new LocalVariableOpcode(Opcode.ISTORE, false));
		opcodes.put(Opcode.LSTORE, new LocalVariableOpcode(Opcode.LSTORE, false));
		opcodes.put(Opcode.FSTORE, new LocalVariableOpcode(Opcode.FSTORE, false));
		opcodes.put(Opcode.DSTORE, new LocalVariableOpcode(Opcode.DSTORE, false));
		opcodes.put(Opcode.ASTORE, new LocalVariableOpcode(Opcode.ASTORE, false));
		opcodes.put(Opcode.ISTORE_0, new LocalVariableOpcode(Opcode.ISTORE_0, false));
		opcodes.put(Opcode.ISTORE_1, new LocalVariableOpcode(Opcode.ISTORE_1, Opcode.ISTORE_0, false));
		opcodes.put(Opcode.ISTORE_2, new LocalVariableOpcode(Opcode.ISTORE_2, Opcode.ISTORE_0, false));
		opcodes.put(Opcode.ISTORE_3, new LocalVariableOpcode(Opcode.ISTORE_3, Opcode.ISTORE_0, false));
		opcodes.put(Opcode.LSTORE_0, new LocalVariableOpcode(Opcode.LSTORE_0, false));
		opcodes.put(Opcode.LSTORE_1, new LocalVariableOpcode(Opcode.LSTORE_1, Opcode.LSTORE_0, false));
		opcodes.put(Opcode.LSTORE_2, new LocalVariableOpcode(Opcode.LSTORE_2, Opcode.LSTORE_0, false));
		opcodes.put(Opcode.LSTORE_3, new LocalVariableOpcode(Opcode.LSTORE_3, Opcode.LSTORE_0, false));
		opcodes.put(Opcode.FSTORE_0, new LocalVariableOpcode(Opcode.FSTORE_0, false));
		opcodes.put(Opcode.FSTORE_1, new LocalVariableOpcode(Opcode.FSTORE_1, Opcode.FSTORE_0, false));
		opcodes.put(Opcode.FSTORE_2, new LocalVariableOpcode(Opcode.FSTORE_2, Opcode.FSTORE_0, false));
		opcodes.put(Opcode.FSTORE_3, new LocalVariableOpcode(Opcode.FSTORE_3, Opcode.FSTORE_0, false));
		opcodes.put(Opcode.DSTORE_0, new LocalVariableOpcode(Opcode.DSTORE_0, false));
		opcodes.put(Opcode.DSTORE_1, new LocalVariableOpcode(Opcode.DSTORE_1, Opcode.DSTORE_0, false));
		opcodes.put(Opcode.DSTORE_2, new LocalVariableOpcode(Opcode.DSTORE_2, Opcode.DSTORE_0, false));
		opcodes.put(Opcode.DSTORE_3, new LocalVariableOpcode(Opcode.DSTORE_3, Opcode.DSTORE_0, false));
		opcodes.put(Opcode.ASTORE_0, new LocalVariableOpcode(Opcode.ASTORE_0, false));
		opcodes.put(Opcode.ASTORE_1, new LocalVariableOpcode(Opcode.ASTORE_1, Opcode.ASTORE_0, false));
		opcodes.put(Opcode.ASTORE_2, new LocalVariableOpcode(Opcode.ASTORE_2, Opcode.ASTORE_0, false));
		opcodes.put(Opcode.ASTORE_3, new LocalVariableOpcode(Opcode.ASTORE_3, Opcode.ASTORE_0, false));
		...
		opcodes.put(Opcode.IINC, new LocalVariableOpcode(Opcode.IINC, false));
		...
		opcodes.put(Opcode.WIDE, new WideOpcode());
